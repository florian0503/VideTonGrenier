...
class ConversationReportCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $queryBuilder->andWhere('entity.type = :type')
                     ->setParameter('type', Report::TYPE_CONVERSATION);
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Signalement de conversation')
            ->setEntityLabelInPlural('Signalements de conversations')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield AssociationField::new('reportedUser', 'Utilisateur signalé')
            ->hideOnForm()
            ->formatValue(function ($value, $entity) {
                return $value ? $value->getFullName() . ' (' . $value->getEmail() . ')' : '';
            });
    ...
    {
        $viewConversation = Action::new('viewConversation', 'Voir la conversation', 'fas fa-comments')
        ...
        return $actions
            ...
            ->add(Crud::PAGE_INDEX, $viewConversation)
    ...
    public function banUser(AdminContext $context, AdminUrlGenerator $adminUrlGenerator): RedirectResponse
    {
        ...
        $admin = $this->getUser();
        $report->getReportedUser()->ban($admin, 'Banni suite au signalement de conversation #' . $report->getId());
    ...
    public function viewConversation(AdminContext $context, MessageRepository $messageRepository): Response
    {
        $reportId = $context->getRequest()->query->get('entityId');
        ...
        $messages = $messageRepository->findAllConversationMessages($report->getAnnonce());
        
        return $this->render('admin/report/conversation.html.twig', [
            'report' => $report,
            'messages' => $messages,
